...
import { Plus, Trash2, Minus, Landmark, PiggyBank } from 'lucide-react';
import { Button, Input, Card } from './ui';
import { numInputValue, readJson } from '../lib/utils';
...
export function BankAccounts() {
  const [data, setData] = useState<BankData>(() =>
    readJson<BankData>('bankAccounts', { accounts: [], savingsAccounts: [] })
  );
